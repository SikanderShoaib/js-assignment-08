let userFirstName = 'Sikander ';
let userLastName = 'Shoaib';
console.log(`Welcome ${userFirstName} ${userLastName}`);


let userMobilePhone = 'iphone X'
...
console.log(cityName.replace('karachi' ,'Islam'));  


var message = "zain and usama are best friends. They play cricket and football together.";
